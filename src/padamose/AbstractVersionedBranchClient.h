...
protected:
    ...
    virtual void        AbstractVersionedBranchClient_print                     ( string prefix, string lgnFilter ) const;
...
public:
    ...
    void                printVersion                            ( size_t version, string lgnFilter = PDM_FILTER_TREE );
