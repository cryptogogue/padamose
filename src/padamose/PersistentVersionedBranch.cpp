...
#include <padamose/PersistentVersionedBranch.h>
...
*/
size_t PersistentVersionedBranch::countDependencies () const {
...
*/
void PersistentVersionedBranch::eraseClient ( AbstractVersionedBranchClient& client ) {
...
*/
size_t PersistentVersionedBranch::findImmutableTop ( const AbstractVersionedBranchClient* ignore ) const {

    LGN_LOG_SCOPE ( PDM_FILTER_ROOT, INFO, "PersistentVersionedBranch::findImmutableTop ()" );
...
*/
const AbstractValueStack* PersistentVersionedBranch::findValueStack ( string key ) const {
...
*/
shared_ptr < PersistentVersionedBranch > PersistentVersionedBranch::fork ( size_t baseVersion ) {
    
    shared_ptr < PersistentVersionedBranch > child = make_shared < PersistentVersionedBranch >();
...
*/
size_t PersistentVersionedBranch::getTopVersion () const {
...
*/
bool PersistentVersionedBranch::hasKey ( size_t version, string key ) const {

    // start searching at the current branch.
    const PersistentVersionedBranch* branch = this;
...
*/
void PersistentVersionedBranch::insertClient ( AbstractVersionedBranchClient& client ) {
...
*/
void PersistentVersionedBranch::optimize () {

    LGN_LOG_SCOPE ( PDM_FILTER_ROOT, INFO, "PersistentVersionedBranch::optimize ()" );
...
//----------------------------------------------------------------//
PersistentVersionedBranch::PersistentVersionedBranch () :
...
*/
void PersistentVersionedBranch::truncate ( size_t topVersion ) {
...
*/
bool PersistentVersionedBranch::AbstractVersionedBranchClient_canJoin () const {
    return true;
}
...
*/
size_t PersistentVersionedBranch::AbstractVersionedBranchClient_getJoinScore () const {
...
*/
size_t PersistentVersionedBranch::AbstractVersionedBranchClient_getVersionDependency () const {
...
*/
void PersistentVersionedBranch::AbstractVersionedBranchClient_joinBranch ( PersistentVersionedBranch& branch ) {

    assert ( branch.mDirectReferenceCount == 0 );
    assert ( this->mDirectReferenceCount == 0 );

    LGN_LOG_SCOPE ( PDM_FILTER_ROOT, INFO, "PersistentVersionedBranch::AbstractVersionedBranchClient_joinBranch ()" );
    LGN_LOG ( PDM_FILTER_ROOT, INFO, "JOINING PARENT BRANCH" );
    
    this->optimize ();
    
    shared_ptr < PersistentVersionedBranch > pinThis = this->shared_from_this ();
...
*/
bool PersistentVersionedBranch::AbstractVersionedBranchClient_preventJoin () const {
